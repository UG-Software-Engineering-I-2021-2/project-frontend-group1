...
import {
    ...
    AccordionButton, AccordionIcon, GridItem, Text, Select, useToast
} from "@chakra-ui/react";
import { ArrowBackIcon } from "@chakra-ui/icons";
import { useHistory, useLocation } from "react-router";
import { GetRubricInfoForGradeStudent, GetStudentsBySection, GetStudentsGradeBySection, RubricGradeSave } from "../../../../api/ApiEndpoints";
...
export const GradeRubric = () => {
    ...
    useEffect(() => {
        ...
        setCompetenceLeft(((100 * left) / total))
        setCompetenceRight(((100 * right) / total))
        setBueno(bueno)
                    ...
                    <Box mt={10}>
...

                        {
                            ...
                            (<Grid templateColumns="repeat(5, 2fr)" gap={6}>
                                ...
                                <Button onClick={console.log} colorScheme='blue'>Finalizar</Button>
                            </Grid>)
                        }
